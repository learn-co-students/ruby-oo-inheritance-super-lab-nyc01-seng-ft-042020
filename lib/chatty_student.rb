...
# # Write a method in the ChattyStudent class, raise_hand, that uses the super 
# keyword ten times so that the method will puts out "Pick me!" ten times. It is 
# possible to simply call super multiple times in a method.
